...
Github repo: [rsspicker](https://git@github.comgeorgegoldman/rsspicker)
...
Internet traffic.
Github repo: [lifeat](git@github.com:georgegoldman/lifeat)

### **Restify Project**
_Sep 6, 2021_
Back end API endpoint.
Github repo: [restify project](git@github.com:georgegoldman/spring-project)
...
Back end API endpoint.
Github repo: [spring project](git@github.com:georgegoldman/spring-project)

### **Miraboi**
_Feb 2, 2022_
Technologies: javascript, html, git, shell
Celebrity website.
Github repo: [miraboi website](Github repo: git@github.com:georgegoldman/miraboi_app)
...
Github repo: [android material designs](git@github.com:georgegoldman/andriodmaterial101)
